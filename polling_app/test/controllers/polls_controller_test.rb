...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { category_id: @poll.category_id, name: @poll.name, user: @poll.user } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { category_id: @poll.category_id, name: @poll.name, user: @poll.user } }
